...
Public Class frmPayCreditNeo
    Private WithEvents poCreditCard As CreditCardNeo
    Private pnLoadx As Integer
    Private poControl As Control
    Private pbCloseForm As Boolean
    Private pnActiveRow As Integer

    WriteOnly Property CreditCard() As CreditCardNeo
        Set(ByVal oCreditCard As CreditCardNeo)
    ...
    Private Sub frmPayCredit_Keydown(sender As Object, e As System.Windows.Forms.KeyEventArgs)
    ...
    Private Sub frmPayCredit_Load(sender As System.Object, e As System.EventArgs)
        setVisible()
...
endProc:
    ...
    Private Sub clearFields()
        ...
        With poCreditCard
            ...
            If .Master(lnRow, "cDebitCrd") = "0" Then
                crdType00.Checked = True
                crdType01.Checked = False
            Else
                crdType00.Checked = False
                crdType01.Checked = True
            End If
        End With
        Call computeChange()
    End Sub
    ...
    Private Function isEntryOk(ByVal DisplayMsg As Boolean) As Boolean
        ...
        If txtField00.Text = String.Empty Then
            If DisplayMsg Then
                MsgBox("Invalid Bank detected..." & vbCrLf &
        ...
        If txtField02.Text = String.Empty Then
            If DisplayMsg Then
                MsgBox("Invalid Approval Number detected..." & vbCrLf &
                        "Please verify your entry then try again...", MsgBoxStyle.Critical, "WARNING")
            End If
            Return False
        End If
        ...
        If txtField04.Text = String.Empty Then
            If DisplayMsg Then
                MsgBox("Invalid Terminal detected..." & vbCrLf &
                        "Please verify your entry then try again...", MsgBoxStyle.Critical, "WARNING")
                Return False
            End If
        End If
    ...
    Private Sub crdType00_CheckedChanged(sender As Object, e As EventArgs) Handles crdType00.CheckedChanged
        If pnLoadx = 0 Then Exit Sub
        poCreditCard.Master(pnActiveRow, "cDebitCrd") = "0"
    End Sub

    Private Sub crdType01_CheckedChanged(sender As Object, e As EventArgs) Handles crdType01.CheckedChanged
        If pnLoadx = 0 Then Exit Sub
        poCreditCard.Master(pnActiveRow, "cDebitCrd") = "1"
    End Sub
End Class